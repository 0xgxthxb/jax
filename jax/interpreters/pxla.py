...
AutoArrayMapping = Union[OrderedDictType[MeshAxisName, int], _AUTOAxisResource]
...
def lower_mesh_computation(
    ...
    fun_name: str,
    mesh: Mesh,
    in_axes: Sequence[AutoArrayMapping],
    out_axes: Union[Sequence[AutoArrayMapping], Callable[[], Sequence[AutoArrayMapping]]],
    donated_invars: Sequence[bool],
    spmd_lowering: bool,
  ...
  auto_spmd_lowering = (all(_is_auto(i) for i in in_axes) and
                        all(_is_auto(o) for o in out_axes))
...
class MeshExecutable(stages.Executable):
  ...
  def from_hlo(name: str,
               ...
               in_axes: Sequence[AutoArrayMapping],
               out_axes: Sequence[AutoArrayMapping],
               spmd_lowering: bool,
               tuple_args: bool,
               in_is_global: Sequence[bool],
